...
pub enum IngestMessage {
    ...
    Fork {
        ...
        base_block_sender: futures_channel::oneshot::Sender<Either<BlockRef, BlockNumber>>
    }
}
...
pub struct Ingest<DC, CB> {
    message_sender: futures_channel::mpsc::Sender<IngestMessage>,
    data_client: DC,
    builder: CB,
