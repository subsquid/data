...
pub enum AnySlice<'a> {
    ...
    Float32(PrimitiveSlice<'a, f32>),
    Float64(PrimitiveSlice<'a, f64>),
...
impl <'a> Slice for AnySlice<'a> {
    fn num_buffers(&self) -> usize {
        match self {
            ...
            AnySlice::Float32(s) => s.num_buffers(),
            AnySlice::Float64(s) => s.num_buffers(),
    ...
    fn byte_size(&self) -> usize {
        match self {
            ...
            AnySlice::Float32(s) => s.byte_size(),
            AnySlice::Float64(s) => s.byte_size(),
    ...
    fn len(&self) -> usize {
        match self {
            ...
            AnySlice::Float32(s) => s.len(),
            AnySlice::Float64(s) => s.len(),
    ...
    fn slice(&self, offset: usize, len: usize) -> Self {
        match self {
            ...
            AnySlice::Float32(s) => AnySlice::Float32(s.slice(offset, len)),
            AnySlice::Float64(s) => AnySlice::Float64(s.slice(offset, len)),
    ...
    fn write(&self, dst: &mut impl ArrayWriter) -> anyhow::Result<()> {
        match self {
            ...
            AnySlice::Float32(s) => s.write(dst),
            AnySlice::Float64(s) => s.write(dst),
    ...
    fn write_range(&self, dst: &mut impl ArrayWriter, range: Range<usize>) -> anyhow::Result<()> {
        match self {
            ...
            AnySlice::Float32(s) => s.write_range(dst, range),
            AnySlice::Float64(s) => s.write_range(dst, range),
    ...
    fn write_ranges(&self, dst: &mut impl ArrayWriter, ranges: &mut impl RangeList) -> anyhow::Result<()> {
        match self {
            ...
            AnySlice::Float32(s) => s.write_ranges(dst, ranges),
            AnySlice::Float64(s) => s.write_ranges(dst, ranges),
    ...
    ) -> anyhow::Result<()> 
    {
        match self {
            ...
            AnySlice::Float32(s) => s.write_indexes(dst, indexes),
            AnySlice::Float64(s) => s.write_indexes(dst, indexes),
...
impl_from_prim!(f32, Float32);
impl_from_prim!(f64, Float64);
